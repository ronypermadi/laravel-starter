...
<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown dropdown-list-toggle"><a href="{{route('message')}}" data-toggle="dropdown" class="nav-link nav-link-lg message-toggle beep"><i class="far fa-envelope"></i></a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
              ...
              <div class="dropdown-footer text-center">
                <a href="{{route('message')}}">View All <i class="fas fa-chevron-right"></i></a>
              </div>
            </div>
          </li>
