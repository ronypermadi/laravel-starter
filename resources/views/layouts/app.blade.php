...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <script defer src="{{ asset('stisla/js/modules/bootstrap.min.js') }}"></script>
        ...
        <script defer src="{{ asset('stisla/js/stisla.js') }}"></script>
        <script defer src="{{ asset('stisla/js/scripts.js') }}"></script>
